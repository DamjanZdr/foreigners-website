        ...
        {submitStatus === 'success' ? (
          ...
          <div className="text-center py-8 animate-fadeIn">
            <div className="mb-6">
              ...
              <p className={`${theme.fontSize.sm} text-gray-700 mb-6`}>
            ...
            <a
              ...
              className={`inline-flex items-center justify-center gap-2 px-6 py-3 bg-green-600 text-white ${theme.radius.lg} hover:bg-green-700 ${theme.transition.default} ${theme.fontWeight.semibold} mb-2`}
            >
              ...
              <span>Chat Now: +48 736 286 264</span>
            </a>
            
            <p className={`${theme.fontSize.xs} text-gray-500 mb-6`}>
              Get instant replies on WhatsApp
            </p>

            <button
              onClick={() => setSubmitStatus('idle')}
              className={`${theme.fontSize.sm} text-primary hover:underline`}
            >
