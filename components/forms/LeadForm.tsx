        ...
        {submitStatus === 'success' ? (
          ...
          <div className="text-center py-8 animate-fadeIn">
            ...
            <p className={`${theme.fontSize.base} text-gray-700 mb-6`}>
              Your request has been successfully submitted. We usually respond within an hour, or you could get an instant response - message us:
            </p>
