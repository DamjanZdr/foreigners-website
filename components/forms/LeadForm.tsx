        ...
        {submitStatus === 'success' ? (
          ...
          <div className="text-center py-6">
            <div className="mb-6">
              ...
              <p className={`${theme.fontSize.base} text-gray-600 mb-4`}>
                Your request has been successfully submitted.
              </p>
            </div>

            <div className={`${theme.radius.lg} bg-blue-50 border border-blue-100 p-4 mb-4 text-left`}>
              <p className={`${theme.fontSize.sm} text-gray-700 mb-3`}>
                We will contact you on WhatsApp at{' '}
                <span className={`${theme.fontWeight.semibold} text-gray-900`}>
                  +48 {submittedPhone}
                </span>{' '}
                within the next hour.
              </p>
              <p className={`${theme.fontSize.sm} text-gray-700`}>
                Want to get started even faster? You can reach out to us directly:
              </p>
            </div>
            ...
            <a
              ...
              className={`inline-flex items-center justify-center gap-2 px-6 py-3 bg-green-600 text-white ${theme.radius.lg} hover:bg-green-700 ${theme.transition.default} ${theme.fontWeight.semibold}`}
            >
            ...
            <p className={`mt-4 ${theme.fontSize.xs} text-gray-500`}>
              We typically respond within 1 hour during business hours
            </p>

            <button
              onClick={() => setSubmitStatus('idle')}
              className={`mt-6 ${theme.fontSize.sm} text-primary hover:underline`}
            >
